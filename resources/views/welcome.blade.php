...
<head>
  ...
  <style>
    @if($leftGradient =opt('hgr_left') AND $rightGradient =opt('hgr_right') AND $fontColor =opt('header_fcolor')) .banner_box,
    .innerheaders {
      background: {
          {
          $leftGradient
    ...
    @endif @if($btnBg =opt('red_btn_bg') AND $btnFt =opt('red_btn_font')) .banner_details a.explore_btn,
